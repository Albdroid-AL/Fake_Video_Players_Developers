...
domReady(function() {
  ...
  function loadPlayer() {
    ...
    playerText+="	<source id='fcplayer_source' src='https://nesertv.live/ntv/livestream/index.m3u8' type='application/x-mpegURL'></source>"
    playerText+="</div>"
    ...
    params = {
      poster:              "https://png.kodi.al/tv/albdroid/black.png", // Posterframe URL
      preload:             "none",
      autoplay:            false,
      playlist: [{
      mediaid:             "NTV AL LIVE",
      title:               "NTV AL LIVE",
      file:                "https://nesertv.live/ntv/livestream/index.m3u8",
      sources:             [],
      live:                true, // Live flag
      ...
      freecaster: {
        player_root:         "https://PLAYER ROOT URL/",
        get_video_path:      "SEE wowza_structure.json", // Will call player_root + get_video_path to get updated playlist item
        ...
        watermark_path:      "http://albdroid.al/uploads/system_logo/logo.png", // Path to SVG
