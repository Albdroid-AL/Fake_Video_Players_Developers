...
/***/ (function(module, exports, __webpack_require__) {
	...
	function qualityPickerPlugin() {
	    ...
	    function onQualityData(event, _ref) {
	        ...
	        player.tech_.on('hlslevelswitched', function (e, data) {
	            ...
	            for (var i in menuItems) {
	                if (menuItems[i].options_.id == data.level && !menuItems[i].hasClass('vjs-selected')) {
	...
	var QualityMenuItem = function (_VjsMenuItem) {
	  ...
	  _createClass(QualityMenuItem, [{
	    ...
	    value: function handleClick(e) {
	      ...
	      for (var i in li) {
	        if (li[i].classList) {
	          if (this.options_.id === -1 && li[i].classList.contains('vjs-selected')) {
	            li[i].classList.remove('vjs-selected');
	            li[i].classList.add('vjs-hls-active');
	          } else if (this.options_.id !== -1) {
	            li[i].classList.remove('vjs-selected');
