...
$API_PATH = $protocol . $_SERVER['SERVER_NAME'] . dirname($_SERVER['PHP_SELF']) . "/APIS/";
$Plugins_Path = $ROOT_URL_MAIN . "" . "";
//echo $Plugins_Path;
...
var path = '<?php echo $Plugins_Path; ?>'; // Auto Player Loader

//var path = 'http://localhost/Player/packages/'; // load player plugins
//var path = 'https://www.vod-platform.net/players/videojs6.2/'; // online  vod
//var path = 'http://rs.vod-platform.net/players/videojs6.2/'; // online test link
