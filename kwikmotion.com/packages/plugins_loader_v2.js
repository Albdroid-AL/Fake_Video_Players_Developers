...
path = 'packages/'; // uncomment for DEVELOPMENT
...
var pluginList = [
  // CUSTOM CONTEXT MENU
  {
    ...
    js: [
      path + 'videojs-contextmenu-ui/videojs-contextmenu-ui.min.js?v=' + JSVersion
    ],
    css: [
    ...
    opts: function(player, mediaid) {
      ...
      return {
        ...
        cancelButtonText: !isArabian
          ...
          : 'Re-watching from the beginning'
      };
    }
  },
  // UPNEXT PLUGIN
...
// http://storage.googleapis.com/testtopbox-public/video_content/bbb/master.m3u8
  ...
  this.insideLoad = function() {
    ...
    var initialLoad = {
	  ...
	  'bowser': path + 'bowser.js?v=' + JSVersion,
